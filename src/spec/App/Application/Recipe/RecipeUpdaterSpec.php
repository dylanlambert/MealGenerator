...
use App\Application\Recipe\RecipeUpdaterResponse;
...
class RecipeUpdaterSpec extends ObjectBehavior
{
    ...
    function it_register(CommandBus $commandBus, IngredientRepository $ingredientRepository)
    {
        ...
        $ingredientRepository->getByIds([new StringId('0046d3dd-dce9-4e6d-8d99-bc8175047135'), new StringId('0060bdca-6d68-4404-924b-c51bb937181b')])->shouldBeCalled()->willReturn($ingredientsList);
